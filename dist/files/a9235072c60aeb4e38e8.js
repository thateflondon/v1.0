/*
 * jQuery css bezier animation support
 */
(function ($) {
  $.path = {};
  var V = {
  ...
  $.path.bezier = function (params, rotate) {
    ...
    this.css = function (p) {
      ...
      css.x = this.x = this.p1[0] * f1 + this.p2[0] * f2 + this.p3[0] * f3 + this.p4[0] * f4 + 0.5 | 0;
      css.y = this.y = this.p1[1] * f1 + this.p2[1] * f2 + this.p3[1] * f3 + this.p4[1] * f4 + 0.5 | 0;
      css.left = css.x + "px";
      css.top = css.y + "px";
      return css;
    };
